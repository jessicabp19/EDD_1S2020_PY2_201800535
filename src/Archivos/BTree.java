...
/*    public void recorridoNiveles() {
    ...
    public void amplitud(Node<T> a) { //INICIAMOS CON RAIZ DEL ARBOL
        LinkedList cola;
        Node<T> aux;
        NodoArbolB auxiliar;
        ...
        if (a != null) { //SI LA RAIZ ES DIFERENTE DE NULL...
            ...
            while (cola.peek() != null) { //MIENTRAS HAYAN LIBROS EN LA COLA...
                aux = (Node<T>) cola.removeLast();//Obtenemos el ultimo
                recorrerImprimir(aux);//Recorremos sus claves y las imprimimos

                for (int i = 0; i < maxChildrenSize; i++) {//CICLO PARA AGREGAR HIJOS
    ...
    public void recorrerImprimir(Node<T> arbol) {
